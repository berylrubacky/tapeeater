...
class ScrobbleRequest(private val context: Context, vararg tracks: Track): LastFMRequest<ScrobbleResponse>() {
    ...
    override suspend fun call(): retrofit2.Response<ScrobbleResponse> = api.scrobble(params)

    override suspend fun manageResponse(response: retrofit2.Response<ScrobbleResponse>) {
